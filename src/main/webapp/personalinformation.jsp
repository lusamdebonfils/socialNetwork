...
<div class="profile-settings-responsive">
	...
	<a href="personalinformation.jsp#" class="js-profile-settings-open profile-settings-open">
		...
		<div class="ui-block">
			<div class="your-profile">
				...
				<div id="accordion1" role="tablist" aria-multiselectable="true">
					<div class="card">
						<div class="card-header" role="tab" id="headingOne-1">
							<h6 class="mb-0">
								<a data-toggle="collapse" data-parent="#accordion" href="personalinformation.jsp#collapseOne-1" aria-expanded="true" aria-controls="collapseOne">
									Profile Settings
						...
						<div id="collapseOne-1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
							<ul class="your-profile-menu">
								<li>
									<a href="personalinformation.jsp">Personal Information</a>
								</li>
								<li>
								...
								<li>
									<a href="hobbiesandinterests.jsp">Hobbies and Interests</a>
								</li>
								<li>
									<a href="educationandemployement.jsp">Education and Employement</a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="ui-block-title">
					...
					<a href="personalinformation.jsp#" class="items-round-little bg-primary">8</a>
				</div>
				<div class="ui-block-title">
				...
				<div class="ui-block-title">
					...
					<a href="personalinformation.jsp#" class="items-round-little bg-blue">4</a>
				</div>
				<div class="ui-block-title ui-block-title-small">
...
<div class="fixed-sidebar">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				<li>
					<a href="personalinformation.jsp#" class="js-sidebar-open">
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			...
			<div class="profile-completion">
				...
				<span>Complete <a href="personalinformation.jsp#">your profile</a> so people can know more about you!</span>
...
<div class="fixed-sidebar fixed-sidebar-responsive">
	...
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left-responsive">
		<a href="personalinformation.jsp#" class="logo js-sidebar-open">
			<img src="img/logo.png" alt="Olympus">
		</a>
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
		<a href="personalinformation.jsp#" class="logo">
			<div class="img-wrap">
				<img src="img/logo.png" alt="Olympus">
			</div>
			<div class="title-block">
...
<div class="fixed-sidebar right">
	<div class="fixed-sidebar-right sidebar--small" id="sidebar-right">
		...
		<a href="personalinformation.jsp#" class="olympus-chat inline-items js-chat-open">
	...
	<div class="fixed-sidebar-right sidebar--large" id="sidebar-right-1">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			...
			<div class="ui-block-title ui-block-title-small">
				<a href="personalinformation.jsp#" class="title">Close Friends</a>
				<a href="personalinformation.jsp#">Settings</a>
			</div>
			...
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Carol Summers</a>
				...
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Mathilda Brinker</a>
				...
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Michael Maximoff</a>
				...
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Rachel Howlett</a>
			...
			<div class="ui-block-title ui-block-title-small">
				<a href="personalinformation.jsp#" class="title">MY FAMILY</a>
				<a href="personalinformation.jsp#">Settings</a>
			</div>
			...
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Sarah Hetfield</a>
						<span class="status">ONLINE</span>
					</div>
			...
			<div class="ui-block-title ui-block-title-small">
				<a href="personalinformation.jsp#" class="title">UNCATEGORIZED</a>
				<a href="personalinformation.jsp#">Settings</a>
			</div>
			...
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Bruce Peterson</a>
						<span class="status">ONLINE</span>
					</div>
				...
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Chris Greyson</a>
						<span class="status">AWAY</span>
					</div>
				...
				<li class="inline-items js-chat-open">
					...
					<div class="author-status">
						<a href="personalinformation.jsp#" class="h6 author-name">Nicholas Grisom</a>
		...
		<div class="search-friend inline-items">
			...
			<a href="editprofile.jsp" class="settings">
...
<header class="header" id="site-header">
	...
	<div class="header-content-wrapper">
		...
		<a href="personalinformation.jsp#" class="link-find-friend">Find Friends</a>
		...
		<div class="control-block">
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					<div class="ui-block-title ui-block-title-small">
						...
						<a href="personalinformation.jsp#">Find Friends</a>
						<a href="personalinformation.jsp#">Settings</a>
					</div>
						...
						<ul class="notification-list friend-requests">
							<li>
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Tamara Romanoff</a>
									<span class="chat-message-item">Mutual Friend: Sarah Hetfield</span>
								</div>
								<span class="notification-icon">
									<a href="personalinformation.jsp#" class="accept-request">
										<span class="icon-add without-text">
											<svg class="olymp-happy-face-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-happy-face-icon"></use></svg>
										</span>
									</a>

									<a href="personalinformation.jsp#" class="accept-request request-del">
							...
							<li>
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Tony Stevens</a>
							...
							<li class="accepted">
								...
								<div class="notification-event">
									You and <a href="personalinformation.jsp#" class="h6 notification-friend">Mary Jane Stark</a> just became friends. Write on <a href="personalinformation.jsp#" class="notification-link">her wall</a>.
								</div>
								<span class="notification-icon">
									<svg class="olymp-happy-face-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-happy-face-icon"></use></svg>
								</span>
							...
							<li>
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Stagg Clothing</a>
					...
					<a href="personalinformation.jsp#" class="view-all bg-blue">Check all your Events</a>
				</div>
			</div>
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					<div class="ui-block-title ui-block-title-small">
						...
						<a href="personalinformation.jsp#">Mark all as read</a>
						<a href="personalinformation.jsp#">Settings</a>
					</div>
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list chat-message">
							<li class="message-unread">
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Diana Jameson</a>
							...
							<li>
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Jake Parker</a>
							...
							<li>
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">Elaine Dreyfuss</a>
							...
							<li class="chat-group">
								...
								<div class="notification-event">
									<a href="personalinformation.jsp#" class="h6 notification-friend">You, Faye, Ed &amp; Jet +3</a>
					...
					<a href="personalinformation.jsp#" class="view-all bg-purple">View All Messages</a>
				</div>
			</div>
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list">
							<li>
								...
								<div class="notification-event">
									<div><a href="personalinformation.jsp#" class="h6 notification-friend">Mathilda Brinker</a> commented on your new <a href="personalinformation.jsp#" class="notification-link">profile status</a>.</div>
									<span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">4 hours ago</time></span>
								</div>
									<span class="notification-icon">
							...
							<li class="un-read">
								...
								<div class="notification-event">
									<div>You and <a href="personalinformation.jsp#" class="h6 notification-friend">Nicholas Grissom</a> just became friends. Write on <a href="personalinformation.jsp#" class="notification-link">his wall</a>.</div>
							...
							<li class="with-comment-photo">
								...
								<div class="notification-event">
									<div><a href="personalinformation.jsp#" class="h6 notification-friend">Sarah Hetfield</a> commented on your <a href="personalinformation.jsp#" class="notification-link">photo</a>.</div>
							...
							<li>
								...
								<div class="notification-event">
									<div><a href="personalinformation.jsp#" class="h6 notification-friend">Green Goo Rock</a> invited you to attend to his event Goo in <a href="personalinformation.jsp#" class="notification-link">Gotham Bar</a>.</div>
							...
							<li>
								...
								<div class="notification-event">
									<div><a href="personalinformation.jsp#" class="h6 notification-friend">James Summers</a> commented on your new <a href="personalinformation.jsp#" class="notification-link">profile status</a>.</div>
					...
					<a href="personalinformation.jsp#" class="view-all bg-primary">View All Notifications</a>
				</div>
			</div>
...
<header class="header header-responsive" id="site-header-responsive">
	...
	<div class="header-content-wrapper">
		<ul class="nav nav-tabs mobile-app-tabs" role="tablist">
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="personalinformation.jsp#request" role="tab">
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="personalinformation.jsp#chat" role="tab">
					<div class="control-icon has-items">
						<svg class="olymp-chat---messages-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-chat---messages-icon"></use></svg>
						<div class="label-avatar bg-purple">2</div>
					</div>
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="personalinformation.jsp#notification" role="tab">
					<div class="control-icon has-items">
						<svg class="olymp-thunder-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-thunder-icon"></use></svg>
						<div class="label-avatar bg-primary">8</div>
					</div>
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="personalinformation.jsp#search" role="tab">
					<svg class="olymp-magnifying-glass-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-magnifying-glass-icon"></use></svg>
					<svg class="olymp-close-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-close-icon"></use></svg>
				</a>
			</li>
						...
						<div class="row">
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<div class="form-group label-floating">
									...
									<input class="form-control" placeholder="" type="text" id="firstName" name="firstName" value="${user.firstName}">
								</div>
					
								<div class="form-group label-floating">
									<label class="control-label" for="email">Your Email</label>
									<input class="form-control" placeholder="" type="email" id="email" name="email" value="${user.email}">
								</div>
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating">
									...
									<input class="form-control" placeholder="" type="text"  id="lastName" name="lastName" value="${user.lastName}">
								</div>
					
								<div class="form-group label-floating">
									<label class="control-label" for="website">Your Website</label>
									<input class="form-control" placeholder="" type="text" id="website" name="website" value="${user.profile.personalInformation.website}">
								</div>
					
					
								<div class="form-group label-floating is-empty">
									<label class="control-label" for="phoneNumber">Your Phone Number</label>
									<input class="form-control" placeholder="" type="text" id="phoneNumber" name="phoneNumber" value="${user.profile.personalInformation.phoneNumber}">
								</div>
							</div>
							...
							<div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="form-group label-floating is-select">
									<label class="control-label" for="state">Your State / Province</label>
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating">
									<label class="control-label" for="description">Write a little description about you</label>
									<textarea class="form-control" id="description" name="description" >${user.profile.personalInformation.description}</textarea>
								</div>

					
								<div class="form-group label-floating is-empty">
									<label class="control-label" for="religion">Religious Belifs</label>
									<input class="form-control" placeholder="" type="text" name="religion" id="religion" value="${user.profile.personalInformation.religion}">
								</div>
							</div>
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating is-empty">
									<label class="control-label" for="placeofBirth">Your Birthplace</label>
									<input class="form-control" placeholder="" type="text" id="placeofBirth" name="placeofBirth" value="${user.profile.personalInformation.birthplace}">
								</div>
					
								<div class="form-group label-floating">
									<label class="control-label" for="occupation">Your Occupation</label>
									<input class="form-control" placeholder="" type="text" value="${user.profile.personalInformation.occupation}" id="occupation" name="occupation" >
								</div>

					
								<div class="form-group label-floating">
									<label class="control-label" for="political">Political Incline</label>
									<input class="form-control" placeholder="" type="text" id="political" name="political" value="${user.profile.personalInformation.political}">
								</div>
							</div>
							<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group with-icon label-floating">
									<label class="control-label" for="facebook">Your Facebook Account</label>
									<input class="form-control" type="text" id="facebook" name="facebook" value="${user.profile.personalInformation.facebookAccount}">
									<i class="fab fa-facebook-f c-facebook" aria-hidden="true"></i>
								</div>
								<div class="form-group with-icon label-floating">
									<label class="control-label" for="twitter">Your Twitter Account</label>
									<input class="form-control" type="text" id="twitter" name="twitter" value="${user.profile.personalInformation.twitterAccount}">
									<i class="fab fa-twitter c-twitter" aria-hidden="true"></i>
								</div>
							</div>
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<button class="btn btn-secondary btn-lg full-width" href="profilepage.jsp">Restore all Attributes</button>
							</div>
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
					...
					<div id="accordion" role="tablist" aria-multiselectable="true">
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<h6 class="mb-0">
									<a data-toggle="collapse" data-parent="#accordion" href="personalinformation.jsp#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										Profile Settings
										<svg class="olymp-dropdown-arrow-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
									</a>
								</h6>
	...
	<div class="modal-content">
		...
		<div class="form-group label-floating is-empty">
			...
			<div class="add-options-message">
				<a href="personalinformation.jsp#" class="options-message">
...
<a class="back-to-top" href="personalinformation.jsp#">
